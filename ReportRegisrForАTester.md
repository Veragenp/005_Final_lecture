...
1. Выполнить проверку перехода на страницу профессии "Тестировщик ПО" (см. сценарии 1.1...1.7);
2. Выполнить переход на форму записи (см. сценарии 4.1...4.3);
3. Выполнить проверку полей (см. сценарии 5.1...5.3);
4. Выполнить проверку формы отправки (см. сценарии 6.1...6.9, 7.1).

_Условие: пользователь зарегистрирован_
1. Войти на сайт как зарегистрированный пользователь (см. сценарий 2.1);
1. Выполнить проверку перехода на страницу профессии "Тестировщик ПО" (см. сценарии 3.1...3.7);
2. Выполнить переход на форму записи (см. сценарии 4.1...4.3);
3. Выполнить проверку полей (см. сценарии 5.1...5.3);
3. Выполнить проверку формы отправки (см. сценарии 8.1...8.9, 9.1).

Выполнить оценку результатов тестирования на основании отчетов, подготовленных с использованием Allure.
...
* QA-middle - постановка задачи, проверка решений, обработка результатов - 4 ч.
